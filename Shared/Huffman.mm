                            ...
                            table2:(NSMutableData*)table2
{
  ...
  {
    int numBytesInTable1 = numEntriesInTable1*sizeof(HuffLookupSymbol);
    [table1 setLength:numBytesInTable1];
  }

  HuffLookupSymbol *table1Ptr = (HuffLookupSymbol *) table1.bytes;
  ...
  table1Symbols.reserve(256);
  
  vector<uint8_t> table2Symbols;
  table2Symbols.reserve(256);
  ...
  
  {
    ...
    int numBytesInTable2 = numEntriesInAllTable2 * sizeof(HuffLookupSymbol);
    
    [table2 setLength:numBytesInTable2];
    
    table2Ptr = (HuffLookupSymbol *) table2.bytes;
  }
